...
public class MyGridLayout extends GridLayout {
    ...
    private void initView() {
        mainHandler = MainActivity.getHandle();
        ...
        soundMap.put(CONNECT_AD, soundPool.load(getContext(), R.raw.connect, 1));
        soundMap.put(GAME_OVER_AD, soundPool.load(getContext(), R.raw.gameover, 1));
        soundMap.put(GET_SCORE_AD, soundPool.load(getContext(), R.raw.get, 1));
